  ...
  return (
    <div className="leader-card">
      ...
      <div className="leader-socials">
        {social.linkedin && <a href={social.linkedin} target="_blank" rel="noreferrer">
            <FaLinkedin size={24} color="#0077b5" />
          </a>}
        {social.twitter && <a href={social.linkedin} target="_blank" rel="noreferrer">
            <FaTwitter size={24} color="#0077b5" />
          </a>}
        {social.facebook && <a href={social.linkedin} target="_blank" rel="noreferrer">
            <FaFacebook size={24} color="#0077b5" />
          </a>}
        {social.instagram && <a href={social.linkedin} target="_blank" rel="noreferrer">
            <FaInstagram size={24} color="#0077b5" />
          </a>}
      </div>
    </div>
  );
